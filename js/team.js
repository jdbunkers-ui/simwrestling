(async function () {
  ...
  try {
    const [payload, awards, seasons, fullSchedule, archivedSeasons, accomplishments] = await Promise.all([
      ...
      SimApi.collegeTeamHistory(teamGuid), SimApi.collegeTeamAccomplishments(teamGuid)
    ]);
