(async function () {
  ...
  try {
    ...
    root.innerHTML = `
      ...
      <nav class="profile-actions single-action"><a class="quiet-link" href="index.html?weight=TEAM&state=${encodeURIComponent(p.state_code)}">Return to Team Rankings</a></nav>
