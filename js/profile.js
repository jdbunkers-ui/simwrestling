(async function () {
  ...
  try {
    const [payload, rankings, structuredAwards] = await Promise.all([
      SimApi.profile(wrestlerGuid), SimApi.rankings(), SimApi.wrestlerAwards(wrestlerGuid)
    ]);
