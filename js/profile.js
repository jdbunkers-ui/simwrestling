(async function () {
  ...
  try {
    const [payload, structuredAwards, seasonHistory] = await Promise.all([
      SimApi.profile(wrestlerGuid), SimApi.wrestlerAwards(wrestlerGuid), SimApi.wrestlerSeasonSummary(wrestlerGuid)
    ]);
