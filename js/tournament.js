(async function () {
  ...
  if (!tournamentGuid) {
    root.innerHTML = '<div class="state-card"><strong>Tournaments are created by the league scheduler.</strong><p><a class="secondary-button" href="schedule.html">View League Schedule</a></p></div>';
    return;
  }
